...
<%
	...
	// 사용자에게 보낼 메시지를 기입합니다.
	String host = "http://localhost:8080/Hellow_world/";
	String from = userDAO.getUserEmail(userID);
	String to = "y2k4388@gmail.com";
	String subject = "강의평가 사이트에서 접수된 신고 메일입니다.";
	String content = "신고자: " + userID + "<br> 신고자 이메일: " + from + "<br>제목: " + reportTitle + "<br>내용: " + reportContent;
